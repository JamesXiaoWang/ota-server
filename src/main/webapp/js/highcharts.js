...
(function(C, Z) {
  typeof module === "object" && module.exports
    ? (module.exports = C.document ? Z(C) : Z)
    : (C.Highcharts = Z(C));
  ...
  function Eb() {
    ...
    jb = function(a, c, d, h, i, k) {
      var j;
      b
        ? ((j = pa.UTC.apply(0, arguments)), (j += Ya(j)))
        : (j = new pa(a, c, p(d, 1), p(h, 0), p(i, 0), p(k, 0)).getTime());
      return j;
    };
    ub = c + "Minutes";
    vb = c + "Hours";
  ...
  w.numberFormat = function(a, b, c, d) {
    ...
    +b &&
      ((d = Math.abs(i - g + Math.pow(10, -Math.max(b, f) - 1))),
  ...
  ka = function(a, b) {
    ...
    if (b === "width")
      return (
        Math.min(a.offsetWidth, a.scrollWidth) -
        ka(a, "padding-left") -
        ka(a, "padding-right")
      );
    else if (b === "height")
  ...
  V = function(a, b, c) {
    ...
    function e() {
      ...
      if (a.nodeName)
        for (f in (b ? ((c = {}), (c[b] = !0)) : (c = g), c))
          if (g[f]) for (e = g[f].length; e--; ) d(f, g[f][e]);
    }
    var f,
      g = a.hcEvents,
      h;
    if (g)
      b
        ? ((f = g[b] || []),
          c
            ? ((h = ra(c, f)), h > -1 && (f.splice(h, 1), (g[b] = f)), d(b, c))
            : (e(), (g[b] = [])))
        : (e(), (a.hcEvents = {}));
  };
  H = function(a, b, c, d) {
  ...
  Wa = function(a, b, c) {
    var d,
      ...
      h;
    X(c) ||
      ((d = arguments), (c = { duration: d[2], easing: d[3], complete: d[4] }));
    if (!ma(c.duration)) c.duration = 400;
    c.easing =
      typeof c.easing === "function"
        ? c.easing
        : Math[c.easing] || Math.easeInOutSine;
    c.curAnim = D(b);
    for (h in b)
      (g = new qb(a, c, h)),
        (f = null),
        h === "d"
          ...
          : a.attr
          ? (d = a.attr(h))
          : ((d = parseFloat(ka(a, h)) || 0), h !== "opacity" && (e = "px")),
        f || (f = b[h]),
  ...
  if (C.jQuery)
    C.jQuery.fn.highcharts = function() {
      ...
      if (this[0])
        return a[0]
          ? (new w[xa(a[0]) ? a.shift() : "Chart"](this[0], a[0], a[1]), this)
          : O[K(this[0], "data-highcharts-chart")];
    };
  A &&
    !A.defaultView &&
    (ka = function(a, b) {
  ...
  S = {
    ...
    global: {
      ...
      VMLRadialGradientURL:
        "http://code.highcharts.com/4.2.4/gfx/vml-radial-gradient.png"
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 0,
  ...
  P.prototype = {
      ...
      if (f) {
        ...
        i[v]
          ...
          : ((g.id = n = "highcharts-" + zb++),
            ...
            o(j, function(a) {
              a[1].indexOf("rgba") === 0
                ? ((e = ja(a[1])), (l = e.get("rgb")), (m = e.get("a")))
                : ((l = a[1]), (m = 1));
              a = d
                .createElement("stop")
                .attr({ offset: a[0], "stop-color": l, "stop-opacity": m })
                .add(k);
              k.stops.push(a);
            }));
        y = "url(" + d.url + "#" + n + ")";
    ...
    css: function(a) {
      ...
      if (e) {
        e = this.textWidth =
          (a && a.width && d.nodeName.toLowerCase() === "text" && F(a.width)) ||
          this.textWidth;
        b && (a = s(b, c));
        this.styles = a;
      ...
      db && a === "click"
        ? ((d.ontouchstart = function(a) {
          ...
          (d.onclick = function(a) {
            (za.indexOf("Android") === -1 ||
              pa.now() - (c.touchEventFired || 0) > 1100) &&
              b.call(d, a);
          }))
        : (d["on" + a] = b);
      return this;
    ...
    getBBox: function(a, b) {
      ...
      e !== z &&
        ...
        (q =
          e === "" || Qb.test(e) ? "num:" + e.toString().length + q : e + q));
      q && !a && (c = m[q]);
      if (!c) {
  ...
  Ca.prototype = {
    ...
    init: function(a, b, c, d, e, f) {
      ...
      this.alignedObjects = [];
      this.url =
        (La || mb) && A.getElementsByTagName("base").length
          ? C.location.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(A.createTextNode("Created with Highcharts 4.2.4"));
    ...
    buildText: function(a) {
      for (
        var b = a.element,
          ...
          m = j && j.lineHeight,
          n = j && j.textShadow,
          q = j && j.textOverflow === "ellipsis",
          v = g.length,
          y = l && !a.added && this.box,
          sa = function(a) {
            return m
              ? F(m)
              : c.fontMetrics(
          ...
          o(e, function(e, f) {
            ...
            o(g, function(e) {
              if (e !== "" || g.length === 1) {
                ...
                i.test(e) &&
                  !d &&
                  (K(v, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                  L(v, { cursor: "pointer" }));
                e = x(e.replace(/<(.|\n)*?>/g, "") || " ");
                if (e !== " ") {
                  ...
                  !m &&
                    f &&
                    (!ca && d && L(v, { display: "block" }), K(v, "dy", sa(v)));
                  if (l) {
                    for (
                      var n = e.replace(/([^\^])-/g, "$1- ").split(" "),
                        p =
                          g.length > 1 ||
                          f ||
                          (n.length > 1 && j.whiteSpace !== "nowrap"),
                        o,
                        u,
                        r,
                        t = [],
                      ...
                      (a.rotation = 0),
                        ...
                        !ca &&
                          c.forExport &&
                          (r = c.measureSpanWidth(v.firstChild.data, a.styles)),
                        (o = r > l),
                        u === void 0 && (u = o),
                        q && u
                          ? ((D /= 2),
                          ...
                          ? ((n = t),
                            ...
                            n.length &&
                              ...
                              b.appendChild(v)),
                            r > l && (l = r))
                          : (v.removeChild(v.firstChild), t.unshift(n.pop())),
                        n.length &&
                          v.appendChild(
                            A.createTextNode(n.join(" ").replace(/- /g, "-"))
                          );
    ...
    symbol: function(a, b, c, d, e, f) {
      ...
      if (i)
        (h = this.path(i)),
          s(h, { symbolName: a, x: b, y: c, width: d, height: e }),
          f && s(h, f);
      else if (k.test(a))
        (l = function(a, b) {
          a.element &&
            ...
            a.alignByTranslate ||
              a.translate(B((d - b[0]) / 2), B((e - b[1]) / 2)));
        }),
          (j = a.match(k)[1]),
    ...
    fontMetrics: function(a, b) {
      ...
      !a &&
        ...
        C.getComputedStyle &&
        ((b = b.element || b),
        (a = (c = C.getComputedStyle(b, "")) && c.fontSize));
    ...
    label: function(a, b, c, d, e, f, g, h, i) {
      ...
      J = function() {
        ...
        a = l.element.style;
        n =
          (p === void 0 || x === void 0 || j.styles.textAlign) &&
          r(l.textStr) &&
          l.getBBox();
        ...
        if (A) {
          if (!m)
            (a = ob),
              (b = (h ? -w : 0) + ob),
              (j.box = m = d
                ? k.symbol(d, a, b, j.width, j.height, Y)
                : k.rect(a, b, j.width, j.height, 0, Y["stroke-width"])),
        ...
        if (b.tagName === "SPAN") {
          ...
          if (m !== this.cTT) {
            ...
            if (b.offsetWidth > j && /[ \-]/.test(b.textContent || b.innerText))
              ...
              L(b, { width: "", display: "", whiteSpace: l || "nowrap" }),
                (this.hasTextWidth = !1);
            this.getSpanCorrection(
              this.hasTextWidth ? j : b.offsetWidth,
              k,
              h,
              i,
              g
  ...
  if (!ca && !ia) {
    ...
    M.prototype.ySetter = M.prototype.widthSetter = M.prototype.heightSetter =
      M.prototype.xSetter;
    var Bb = {
      Element: M,
      ...
      init: function(a, b, c, d) {
        ...
        d = this.createElement(Ka).css(
          s(this.getStyle(d), { position: "relative" })
        );
        e = d.element;
      ...
      color: function(a, b, c, d) {
        ...
        if (i) {
          ...
          o(a, function(a, b) {
            g.test(a[1])
              ? ((f = ja(a[1])), (j = f.get("rgb")), (l = f.get("a")))
              : ((j = a[1]), (l = 1));
            r.push(a[0] * 100 + "% " + j);
            b ? ((v = l), (y = j)) : ((q = l), (p = j));
          });
            ...
            if (i === "gradient")
              ...
              var k = m.r,
                ...
                k = function() {
                  z &&
                    ((A = d.getBBox()),
                    (w += (z[0] - A.x) / A.width - 0.5),
                    (B += (z[1] - A.y) / A.height - 0.5),
                    (Y *= z[2] / A.width),
                    (s *= z[2] / A.height));
                  x =
                    'src="' +
                    S.global.VMLRadialGradientURL +
                    '" size="' +
                    Y +
                    "," +
                    s +
      ...
      symbols: {
        ...
        rect: function(a, b, c, d, e) {
          return Ca.prototype.symbols[
            !r(e) || !e.r ? "square" : "callout"
          ].call(0, a, b, c, d, e);
        }
      }
    };
  ...
  Va.prototype = {
    addLabel: function() {
      ...
      a.isDatetimeAxis &&
        h &&
        (j = b.dateTimeLabelFormats[h.higherRanks[f] || h.unitName]);
      this.isFirst = i;
      this.isLast = k;
    ...
    handleOverflow: function(a) {
      ...
      if (h)
        ...
        l < j &&
          b.labelAlign === "center" &&
          (a.x += m * (j - l - i * (j - E(k, l)))),
        k > l || (b.autoRotation && g.styles.width))
      )
        n = l;
      if (n) {
        q.width = n;
      ...
      r(n) ||
        (n =
          i.side === 0
            ...
            : i.side === 2
            ? m.y + 8
            : U(c.rotation * ha) * (m.y - c.getBBox(!1, 0).height / 2));
      ...
      if (m)
        d.opposite && (m[0] = -m[0]),
          ...
          o
            ...
            : (this.mark = f
                .path(h)
                .attr({ stroke: n, "stroke-width": m[1], opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(Y))
        (i.xy = t = this.getLabelPosition(Y, t, i, g, j, r, a, x)),
  ...
  w.PlotLineOrBand.prototype = {
    render: function() {
      ...
      if (g) {
        if (
          ((n = b.getPlotLinePath(j, g)),
          (x = { stroke: v, "stroke-width": g }),
          l)
        )
          x.dashstyle = l;
      } else if (k) {
      ...
      if (m)
        ...
        o))
          d(q);
      e && r(e.text) && n && n.length && b.width > 0 && b.height > 0 && !n.flat
        ? ((e = D(
            {
              align: c && k && "center",
              x: c ? !k && 4 : 10,
  ...
  fa.prototype = {
    ...
    init: function(a, b) {
      ...
      this.crosshair = p(
        d.crosshair,
        ta(a.options.tooltip.crosshairs)[c ? 0 : 1],
        !1
      );
      var f,
    ...
    defaultLabelFormatter: function() {
      ...
      g === z &&
        (g =
          Q(b) >= 1e4 ? w.numberFormat(b, -1) : w.numberFormat(b, -1, z, ""));
      return g;
    },
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              (a.dataMin = E(p(a.dataMin, d[0]), Qa(d))),
    ...
    getPlotLinePath: function(a, b, c, d, e) {
      ...
      return m && !d
        ? null
        : f.renderer.crispLine(["M", a, i, "L", c, k], b || 1);
    },
    ...
    setTickInterval: function(a) {
      ...
      i
        ? ((b.linkedParent = c[b.coll][d.linkedTo]),
          ...
          d.type !== b.linkedParent.options.type && Z(11, 1))
        : (!v &&
            r(q) &&
            (b.dataMin >= q
              ? ((y = q), (j = 0))
              : b.dataMax <= q && ((sa = q), (k = 0))),
          (b.min = p(x, y, b.dataMin)),
          (b.max = p(u, sa, b.dataMax)));
      if (e)
        !a && E(b.min, p(b.dataMin, b.min)) <= 0 && Z(10, 1),
          (b.min = da(f(b.min), 15)),
          (b.max = da(f(b.max), 15));
      if (b.range && r(b.max))
        (b.userMin = b.min = x = t(b.min, b.minFromRange())),
          (b.userMax = u = b.max),
          (b.range = null);
      ...
      b.tickInterval =
        b.min === b.max || b.min === void 0 || b.max === void 0
          ? 1
          : i && !l && m === b.linkedParent.options.tickPixelInterval
    ...
    setAxisSize: function() {
      ...
      c.test(g) &&
        (g = Math.round((parseFloat(g) / 100) * a.plotHeight + a.plotTop));
      this.left = b;
      this.top = g;
      this.width = e;
      this.height = f;
    ...
    unsquish: function() {
      ...
      b
        ? (j =
            !a.staggerLines &&
            !a.step &&
            (r(g) ? [g] : e < p(a.autoRotationLimit, 80) && a.autoRotation)) &&
          o(j, function(a) {
            var b;
            if (a === g || (a && a >= -90 && a <= 90))
              (i = l(Q(h.h / aa(ha * a)))),
    ...
    getSlotWidth: function() {
      ...
      return (
        ...
        (!b && ((e && e - a.spacing[3]) || a.chartWidth * 0.33))
      );
    },
    renderUnsquish: function() {
      ...
      if (this.autoRotation)
        ...
        for (n = c.length; !f && n--; )
          if (((q = c[n]), (h = d[q].label)))
            if (
              (h.styles.textOverflow === "ellipsis"
                ? h.css({ textOverflow: "clip" })
                : d[q].labelLength > g && h.css({ width: g + "px" }),
      ...
      if (
        ...
        ((l = {
          width:
            (m > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) +
            "px"
        }),
        !j)
      )
      ...
      if (
        (this.labelAlign = e.align || this.autoLabelAlign(this.labelRotation))
      )
    ...
    getOffset: function() {
      ...
      if (k || a.isLinked) {
        if (
          ...
          (y *= a.staggerLines), (a.labelOffset = y * (a.opposite ? -1 : 1));
      ...
      x[h] = t(
        x[h],
        a.axisTitleMargin + l + u * a.offset,
        n,
        k && e.length && Y ? Y[0] : 0
      );
    ...
    render: function() {
      var a = this,
        ...
        v = d.lineWidth,
        p,
        sa = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin),
        x = a.showAxis,
      ...
      if (a.hasData() || g) {
        ...
        n &&
          o(h, function(c, d) {
            ...
            if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -q : q))
              l[c] || (l[c] = new w.PlotLineOrBand(a)),
                (t = c + q),
                (l[c].options = {
                  from: e ? f(t) : t,
                  to: e ? f(s) : s,
      ...
      if (v)
        (p = a.getLinePath(v)),
          a.axisLine
            ? a.axisLine.animate({ d: p })
            : (a.axisLine = c
                .path(p)
                .attr({ stroke: d.lineColor, "stroke-width": v, zIndex: 7 })
                .add(a.axisGroup)),
    ...
    if (r(b)) {
      ...
      for (
        var d = i.getTime(),
          ...
          m = i[Ua](),
          n = !g || !!Za,
          q = (G.day + (g ? Ya(i) : i.getTimezoneOffset() * 6e4)) % G.day;
        d < c;
  ...
  fa.prototype.getLogTickPositions = function(a, b, c, d) {
    ...
    if (a >= 0.5) (a = B(a)), (i = this.getLinearTickPositions(a, b, c));
      ...
      (a = tb(a, null, sb(a))),
      (i = Ba(this.getLinearTickPositions(a, b, c), h)),
      !d)
    )
  ...
  Ob.prototype = {
    ...
    getAnchor: function(a, b) {
      ...
      this.followPointer &&
        b &&
        (b.chartX === z && (b = d.pointer.normalize(b)),
    ...
    refresh: function(a, b) {
      ...
      k === !1
        ? this.hide()
        : (this.isHidden && (Na(d), d.attr("opacity", 1).show()),
          d.attr({ text: k }),
  ...
  Xa.prototype = {
      ...
      g && (e ? g.noSharedTooltip : g.directTouch) && f
        ...
        : (o(c, function(b) {
            ...
            b.visible &&
              ...
              (n = b.searchPoint(a, !k && b.kdDimensions === 1)) &&
              l.push(n);
          }),
          o(l, function(a) {
            a &&
      ...
      if (a)
        g &&
          ...
          e &&
            ...
            o(c.axes, function(a) {
              p(a.crosshair && a.crosshair.snap, !0)
    ...
    drag: function(a) {
      ...
      if (!m || !m.touch)
        if (
          ...
          m &&
            g &&
            ((d = e - q), m.attr({ height: Q(d), y: (d > 0 ? 0 : d) + q }));
    ...
    onContainerClick: function(a) {
      ...
      b.cancelClick ||
        (c && this.inClass(a.target, "highcharts-tracker")
          ? (H(c.series, "click", s(a, { point: c })),
            b.hoverPoint && c.firePointEvent("click", a))
          : (s(a, this.getCoordinates(a)),
    ...
    destroy: function() {
      ...
      eb ||
        (V(A, "mouseup", this.onDocumentMouseUp),
        V(A, "touchend", this.onDocumentTouchEnd));
  ...
  s(w.Pointer.prototype, {
    ...
    pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
      ...
      b < x.min
        ? ((b = x.min), (w = !0))
        : b + q > x.max && ((b = x.max - q), (w = !0));
      w
        ? ((r -= 0.8 * (r - g[k][0])), u || (z -= 0.8 * (z - g[k][1])), c())
        : (g[k] = [r, z]);
      o || ((f[k] = v - n), (f[m] = q));
      f = o ? 1 / p : p;
      e[m] = q;
    ...
    pinch: function(a) {
      ...
      if (a.type === "touchstart")
        ...
        if (!i)
          b.selectionMarker = i = s({ destroy: Aa, touch: !0 }, c.plotBox);
  ...
  pb.prototype = {
    ...
    destroyItem: function(a) {
      var b = a.checkbox;
      o(["legendItem", "legendLine", "legendSymbol", "legendGroup"], function(
        b
      ) {
        a[b] && (a[b] = a[b].destroy());
      });
    ...
    renderItem: function(a) {
      ...
      if (!o) {
        ...
        a.legendItem = o = c
          .text("", l ? f + g : -g, this.baseline || 0, u)
          .css(D(a.visible ? h : i))
      ...
      c = o.getBBox();
      f = a.checkboxOffset =
        d.itemWidth || a.legendItemWidth || f + g + c.width + j + (x ? 20 : 0);
  ...
  gb.prototype = {
    ...
    redraw: function(a) {
      ...
      if (h)
        for (l = j; l--; ) if (((a = c[l]), a.options.stacking)) a.isDirty = !0;
      o(c, function(a) {
        a.isDirty &&
    ...
    layOutTitles: function(a) {
      ...
      if (
        ...
        (c
          ...
          .align(
            s({ y: g.fontMetrics(f.style.fontSize, c).b - 3 }, f),
            !1,
            "spacingBox"
          ),
    ...
    cloneRenderTo: function(a) {
      var b = this.renderToClone,
        c = this.container;
      a
        ? b && (this.renderTo.appendChild(c), Sa(b), delete this.renderToClone)
    ...
    getContainer: function() {
      ...
      this.renderer = new (w[c.renderer] || cb)(
        a,
        d,
        e,
        c.style,
    ...
    drawChartBox: function() {
      ...
      if (j)
        f
          ...
          : (this.plotBackground = b
              ...
              .shadow(a.plotShadow));
      if (l)
        h ? h.animate(x) : (this.plotBGImage = b.image(l, q, p, o, r).add());
      u
      ...
      if (m)
        g
          ? ((g.strokeWidth = -m),
            g.animate(g.crisp({ x: q, y: p, width: o, height: r })))
          : (this.plotBorder = b
              .rect(q, p, o, r, 0, -m)
              .attr({
    ...
    isReadyToRender: function() {
      var a = this;
      return (!ca && C == C.top && A.readyState !== "complete") ||
        (ia && !C.canvg)
        ? (ia
            ? Nb.push(function() {
                a.firstRender();
  ...
  R.prototype = {
    ...
    setOptions: function(a) {
      ...
      this.tooltipOptions = D(
        S.tooltip,
        S.plotOptions[this.type].tooltip,
        b.tooltip,
    ...
    getColor: function() {
      this.options.colorByPoint
        ...
        : this.getCyclic(
            "color",
            this.options.color || ba[this.type].color,
        ...
        if (n && h > n) {
          ...
          for (c = 0; c < h; c++)
            if (
              a[c] !== z &&
              ((j = { series: e }),
              e.pointClass.prototype.applyOptions.apply(j, [a[c]]),
              e.updateParallelArrays(j, c),
              m && r(j.name))
            )
              l.names[j.x] = j.name;
        xa(v[0]) && Z(14, !0);
    ...
    processData: function(a) {
      ...
      if (l && this.sorted && !j && (!i || d > i || this.forceCrop))
        if (b[d - 1] < n || b[0] > q) (b = []), (c = []);
          ...
          (e = this.cropData(this.xData, this.yData, n, q)),
            (b = e.xData),
            (c = e.yData),
            (e = e.start),
            (f = !0);
        ...
        (i = h + m),
          k
            ? ((l[m] = new f().init(this, [d[m]].concat(ta(e[m])))),
              (l[m].dataGroup = this.groupMap[m]))
            : (b[i]
                ? (j = b[i])
                : a[i] !== z && (b[i] = j = new f().init(this, a[i], d[m])),
              (l[m] = j)),
          (l[m].index = i);
      if (b && (g !== (c = b.length) || k))
        for (m = 0; m < c; m++)
    ...
    translate: function() {
      ...
      for (
        ...
        var w =
          b &&
          e.stacks[
            (this.negStacks && u < (l ? 0 : j) ? "-" : "") + this.stackKey
          ];
        if (e.isLog && u !== null && u <= 0) (s.y = u = null), Z(10);
        s.plotX = m = E(
          t(-1e5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")),
          1e5
        );
        ...
        s.plotY = n =
          typeof u === "number" && u !== Infinity
            ? E(t(-1e5, e.translate(u, 0, 1, 0, 1)), 1e5)
            : z;
      ...
      if (l.enabled !== !1 || this._hasPointMarkers)
        for (f = b.length; f--; )
          if (
            ...
            (n = g.marker || {}),
            (q = !!g.marker),
            (a = (r && n.enabled === z) || n.enabled),
            (o = g.isInside),
            a && e !== z && !isNaN(e) && g.y !== null)
          )
            if (
              ...
              if (o && (h > 0 || k))
                g.graphic = c.renderer
                  .symbol(i, d - h, e - h, 2 * h, 2 * h, q ? n : l)
                  .attr(a)
                  .add(y);
            }
    ...
    destroy: function() {
      ...
      o(a.axisTypes || [], function(b) {
        if ((h = a[b])) na(h.series, a), (h.isDirty = h.forceRedraw = !0);
      });
      ...
      o(c, function(c, i) {
        ...
        if (j) j.animate({ d: f });
          ...
          (j = { stroke: c[1], "stroke-width": d, fill: g, zIndex: 1 }),
            c[2]
              ? (j.dashstyle = c[2])
              : e && (j["stroke-linecap"] = j["stroke-linejoin"] = "round"),
      ...
      if (d.length && (i || k) && l.min !== z)
        i && i.hide(),
          ...
          o(d, function(d, o) {
            ...
            x = t(e, f);
            if (l.isXAxis) {
              if (((h = { x: q ? x : r, y: 0, width: y, height: j }), !v))
                h.x = b.plotHeight - h.x;
            } else if (((h = { x: 0, y: q ? x : r, width: j, height: y }), v)) h.y = b.plotWidth - h.y;
            b.inverted &&
              c.isVML &&
              (h = l.isXAxis
                ? { x: 0, y: n ? r : x, height: h.width, width: b.chartWidth }
                : {
      ...
      for (x = 0; x < d; x++) {
        ...
        if (!m[y][u])
          n[y] && n[y][u]
            ...
            : (m[y][u] = new Jb(l, l.options.stackLabels, o, u, h));
        y = m[y][u];
        if (s !== null)
          (y.points[r] = y.points[this.index] = [p(y.cum, g)]),
            (y.touched = l.stacksTouched),
            q.index > 0 &&
              this.singleStacks === !1 &&
              (y.points[r][0] = y.points[this.index + "," + u + ",0"][0]);
        e === "percent"
          ? ((o = o ? i : k),
            j && m[o] && m[o][u]
              ? ((o = m[o][u]),
                (y.total = o.total = t(o.total, y.total) + Q(s) || 0))
    ...
    showLoading: function(a) {
      ...
      if (!d)
        (b.loadingDiv = d = $(
          ...
          s(e.style, { zIndex: 10, display: "none" }),
          b.container
        )),
  ...
  wa = oa(R, {
    ...
    getPointSpline: function(a, b, c) {
      ...
      if (f && !f.isNull && c && !c.isNull) {
        ...
        h > a && h > e
          ? ((h = t(a, e)), (k = 2 * e - h))
          : h < a && h < e && ((h = E(a, e)), (k = 2 * e - h));
        k > c && k > e
          ? ((k = t(c, e)), (h = 2 * e - k))
          : k < c && k < e && ((k = E(c, e)), (h = 2 * e - k));
        b.rightContX = i;
        b.rightContY = k;
      }
      b = [
        "C",
        p(f.rightContX, f.plotX),
        p(f.rightContY, f.plotY),
        p(g, d),
        p(h, e),
        d,
        e
  ...
  wa = oa(R, {
    ...
    getColumnMetrics: function() {
      ...
      var i = E(
        ...
        b = E(
          ...
          p(b.pointWidth, j * (1 - 2 * b.pointPadding))
        );
      a.columnMetrics = {
        width: b,
        offset:
          (j - b) / 2 +
          (k + ((a.columnIndex || 0) + (e ? 1 : 0)) * j - i / 2) * (e ? -1 : 1)
      };
    ...
    translate: function() {
      ...
      o(a.points, function(c) {
        ...
        Q(x) < g &&
          ...
          (s = Q(s - f) > g ? d - g : f - (w ? g : 0)));
        c.barX = o;
        c.pointWidth = i;
        c.tooltipPos = b.inverted
          ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - o - r / 2, x]
    ...
    drawPoints: function() {
      ...
      o(a.points, function(h) {
        ...
        if (i !== z && !isNaN(i) && h.y !== null)
          (f = h.shapeArgs),
            (i = r(a.borderWidth) ? { "stroke-width": a.borderWidth } : {}),
            ...
            k
              ? (Na(k),
                k
                  .attr(i)
                  .attr(g)
                  [b.pointCount < e ? "animate" : "attr"](D(f)))
    ...
    animate: function(a) {
      ...
      if (ca)
        a
          ? ((f.scaleY = 0.001),
            (a = E(c.pos + c.len, t(c.pos, c.toPixels(d.threshold)))),
            e ? (f.translateX = a - c.len) : (f.translateY = a),
            b.group.attr(f))
          : ((f[e ? "translateX" : "translateY"] = c.pos),
            b.group.animate(
              f,
              s($a(b.options.animation), {
                step: function(a, c) {
  ...
  R.prototype.alignDataLabel = function(a, b, c, d, e) {
    ...
    if (n)
      (d = s(
        ...
        s(c, { width: k.width, height: k.height }),
        l
          ? ((o = !1),
        ...
        o
          ...
          : p(c.crop, !0) &&
            (n =
              ...
              f.isInsidePlot(g.x + k.width, g.y + k.height)),
  ...
  R.prototype.justifyDataLabel = function(a, b, c, d, e, f) {
    ...
    k = c.y + d.height - l;
    if (k > g.plotHeight)
      i === "top" ? (b.verticalAlign = "bottom") : (b.y = g.plotHeight - k),
        (j = !0);
  ...
  if (I.pie)
    (I.pie.prototype.drawDataLabels = function() {
          ...
          if (M) {
            ...
            for (J = b = 0; !b && I[J]; )
              (b =
                I[J] &&
                I[J].dataLabel &&
                (I[J].dataLabel.getBBox().height || 21)),
                J++;
            if (m > 0) {
            ...
            for (J = 0; J < M; J++) {
              ...
              if (m > 0) {
                if (
                  ...
                  (K = x.i),
                  (C = x.y),
                  (c > C && H[K + 1] !== null) || (c < C && H[K - 1] !== null))
                )
                  C = E(t(0, c), d.plotHeight);
              } else C = c;
              A = e.justify
                ? n[0] + (F ? -1 : 1) * (q + m)
                : a.getX(C === r - q - m || C === r + q + m ? c : C, F);
              ...
              o(this.points, function(b) {
                ...
                if ((w = b.dataLabel) && w._pos && b.visible)
                  (D = w._attr.visibility),
                    ...
                    k
                      ? (k.animate({ d: j }), k.attr("visibility", D))
      ...
      (I.pie.prototype.verifyDataLabelOverflow = function(a) {
        ...
        d[1] !== null
          ? (f = t(E(f, b[2] - t(a[0], a[2])), e))
          : ((f = t(E(f, b[2] - a[0] - a[2]), e)), (b[1] += (a[0] - a[2]) / 2));
        f < b[2]
          ? ((b[2] = f),
            (b[3] = Math.min(
              /%$/.test(c.innerSize || 0)
      ...
      if (
        ...
        if (this.graphic)
          (g = g && this.graphic.symbolName && o.r),
            this.graphic.attr(
              D(o, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})
            ),
            j && j.hide();
        else {
          if (a && i)
            if (
              ((g = i.radius),
              (l = l.symbol || e.symbol),
              j && j.currentSymbol !== l && (j = j.destroy()),
              j)
            )
