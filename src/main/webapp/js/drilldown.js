...
(function (n) {
    ...
    (function (f) {
        var n = f.noop, y = f.color, z = f.defaultOptions, h = f.each, p = f.extend, G = f.format, A = f.objectEach,
            B = f.pick, u = f.wrap, q = f.Chart, v = f.seriesTypes, C = v.pie, r = v.column, D = f.Tick,
            w = f.fireEvent, E = f.inArray, F = 1;
        p(z.lang, {drillUpText: "\u25c1 Back to {series.name}"});
        z.drilldown = {
        ...
        f.SVGRenderer.prototype.Element.prototype.fadeIn = function (b) {
            this.attr({
                opacity: .1,
                visibility: "inherit"
            }).animate({opacity: B(this.newOpacity, 1)}, b || {duration: 250})
        };
        ...
        q.prototype.showDrillUpButton = function () {
            var b = this, a = this.getDrilldownBackText(), d = b.options.drilldown.drillUpButton, c, e;
        ...
        q.prototype.drillUp = function () {
            for (var b = this, a = b.drilldownLevels, d = a[a.length - 1].levelNumber, c = a.length, e = b.series, g, l, k, f, m = function (a) {
            ...
            }; c--;) if (l = a[c], l.levelNumber === d) {
                a.pop();
                k = l.lowerSeries;
                if (!k.chart) for (g = e.length; g--;) if (e[g].options.id === l.lowerSeriesOptions.id && e[g].options._levelNumber ===
                    d + 1) {
                    k = e[g];
                    break
                }
                ...
                w(b, "drillup", {seriesOptions: l.seriesOptions});
        ...
        r.prototype.animateDrilldown = function (b) {
            var a = this, d = this.chart.drilldownLevels, c, e = this.chart.options.drilldown.animation, g = this.xAxis;
            b || (h(d, function (b) {
        ...
        r.prototype.animateDrillupFrom = function (b) {
            var a = this.chart.options.drilldown.animation, d = this.group, c = d !== this.chart.seriesGroup, e = this;
            h(e.trackerGroups, function (a) {
                if (e[a]) e[a].on("mouseover")
            });
            c && delete this.group;
            h(this.points, function (e) {
                var g = e.graphic, k = b.shapeArgs, h = function () {
                    g.destroy();
                    d && c && (d = d.destroy())
                };
                g && (delete e.graphic, k.fill = b.color, a ? g.animate(k, f.merge(a, {complete: h})) : (g.attr(k), h()))
            })
        };
        C && p(C.prototype,
            {
        ...
        f.Point.prototype.doDrilldown = function (b, a, d) {
            var c = this.series.chart, e = c.options.drilldown, g = (e.series || []).length, f;
            c.ddDupes || (c.ddDupes = []);
        ...
        D.prototype.drillable = function () {
            var b = this.pos, a = this.label,
                d = this.axis, c = "xAxis" === d.coll && d.getDDPoints, e = c && d.getDDPoints(b);
