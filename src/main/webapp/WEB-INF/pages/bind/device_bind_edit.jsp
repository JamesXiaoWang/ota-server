        ...
        <div class="widget-container fluid-height clearfix">
            ...
            <div class="grid-structure">
                ...
                <form class="FormAjax form-horizontal" id="form" autocomplete="off" method="post"
                      action="${basePath}device/updateDeviceBindInfo">

                    <div class="form-group">
                        <label for="devId" class="control-label col-md-3">设备ID<span class="w6 red">*</span></label>
                        <div class="col-md-6">
                            <input type="text" autocomplete="off" id="devId" name="devId" value="${deviceId}"
                                   class="form-control CascadeAjaxCd" disabled="disabled">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="imeiNumber" class="control-label col-md-3">设备唯一标识<span class="w6 red">*</span></label>
                        <div class="col-md-6">
                            <input type="text" autocomplete="off" placeholder="请输入设备唯一标识" id="imeiNumber" name="imeiNumber"
                                   value="${IMEI}"
                                   class="form-control CascadeAjaxCd">
                        </div>
                        <div class="col-md-3" for="model_id"></div>
                    </div>
                    ...
                    <input type="text" id="deviceId" name="deviceId" value="${deviceId}" style="display: none">
                    <input type="text" id="pageNo" name="pageNo" value="${index}" style="display: none">
                </form>
...
<script>
    function isCheck() {
        ...
        if ("" == number || null == number) {
            ...
            var result = false;
            $.ajax({
                url: '/ota-server/device/deviceBindInfoCheck',
                dataType: 'json',
                type: 'GET',
                async: false,
                data: {number},
                success: function (data) {
                    ...
                    if (300 == data.code) {
                        ...
                        var dialog = new BootstrapDialog.show({
                            title: '操作提示',
                            message: '这个IMEI号不存在，请检查此IMEI号的合法性'
                        });
                        dialog.getModalBody().css('color', 'red');
                        result = false;
                    } else {
