    ...
    <div class="col-lg-12">
        <div class="widget-container fluid-height clearfix">
            ...
            <div class="grid-structure">
                ...
                <form class="FormAjax form-horizontal" id="form" method="post"
                      action="${basePath}list/addDeviceNumber">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3"></label>
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-primary fl" id="btn" onclick="return isCheck()">提交
                            </button>
                            <button type="button" onclick="javascript:history.go(-1);" class="btn btn-primary fl ml10">
                                返回
                            </button>
                        </div>
                        <%--<input type="text" id="pageNo" name="pageNo" value="${index}">--%>
                    </div>
                </form>
...
<script>
    function isCheck() {
        ...
        if ("" == number || null == number) {
            ...
            var result = false;
            $.ajax({
                url: '/ota-server/list/deviceNumberCheck',
                dataType: 'json',
                type: 'GET',
                async: false,
                data: {number},
